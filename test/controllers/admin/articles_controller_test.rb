...
class Admin::ArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_article" do
    assert_difference('Admin::Article.count') do
      post admin_articles_url, params: { admin_article: { image: @admin_article.image, text: @admin_article.text, title: @admin_article.title } }
    end
  ...
  test "should update admin_article" do
    patch admin_article_url(@admin_article), params: { admin_article: { image: @admin_article.image, text: @admin_article.text, title: @admin_article.title } }
